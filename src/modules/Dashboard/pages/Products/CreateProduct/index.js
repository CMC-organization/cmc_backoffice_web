          ...
          <div key={field.id} className='flex border-b py-4'>
           ...
           <div>
            ...
            <div className='pb-4'>
             <label
              htmlFor={`icon${index}`}
              className='cursor-pointer rounded-full overflow-hidden h-11 w-full border-2 border-dashed flex justify-center'
             >
              {icons[index] ? (
            ...
            <div className='flex gap-4'>
             <Input
              name={`variables[${index}].option`}
              label='Opção'
              error={errors.variables && errors.variables[index] && errors.variables[index].option}
             ...
             <Input
              ...
              error={errors.variables && errors.variables[index] && errors.variables[index].value}
              placeholder='0,00'
              control={control}
             />
            </div>
