...
import NoVariationSelect from '../../../../../images/svg/NoVariationSelect';
   ...
   content={
    <form onSubmit={handleSubmit(onSubmit)} className=' flex flex-col gap-10 pb-10'>
     <div className='flex items-center gap-9'>
      ...
      <Header page='Criar fabricação' name='Teste' />
     </div>
      ...
      <div className='w-1/2 h-full border border-border rounded-xl'>
       ...
       {variations ? (
        ...
        <div className='w-full h-full flex flex-col items-center justify-center'>
         <NoVariationSelect />
         <p className='text-base font-medium'>Selecione um produto para configurar a produção</p>
        </div>
       )}
      </div>
     </div>
